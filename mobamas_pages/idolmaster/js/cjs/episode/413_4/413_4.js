...
(lib.bg = function() {
	this.initialize(img._413_4_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1280,1400);


(lib.book = function() {
	this.initialize(img._413_4_book);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,760,432);


(lib.ch_base = function() {
	this.initialize(img._413_4_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1280,1400);


(lib.ch_face10 = function() {
	this.initialize(img._413_4_ch_face10);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.ch_face11 = function() {
	this.initialize(img._413_4_ch_face11);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.ch_face2 = function() {
	this.initialize(img._413_4_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.ch_face3 = function() {
	this.initialize(img._413_4_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.ch_face4 = function() {
	this.initialize(img._413_4_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.ch_face5 = function() {
	this.initialize(img._413_4_ch_face5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.ch_face6 = function() {
	this.initialize(img._413_4_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.ch_face7 = function() {
	this.initialize(img._413_4_ch_face7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.ch_face9 = function() {
	this.initialize(img._413_4_ch_face9);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.finish = function() {
	this.initialize(img._413_4_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._413_4_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.tie_fp = function() {
	this.initialize(img._413_4_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._413_4_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
(lib.drop = function(mode,startPosition,loop) {
	...
	// レイヤー 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	...
	// レイヤー 2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,0,0.298)").s().p("");
	this.shape_1.setTransform(0,2.55);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-18.8,-9.6,37.6,22.799999999999997);
...
}).prototype = getMCSymbolPrototype(lib.character1_base, new cjs.Rectangle(-120,-396,640,700), null);
...
(lib.drop_1 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(35).call(this.frame_35).wait(177));

	// drop_1
	this.instance = new lib.drop("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(-80.6,321.15,0.092,0.2103,30.0006);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:-0.5,regY:0.3,scaleX:0.091,scaleY:0.2452,rotation:7.2723,x:-78.35,y:320.95,alpha:0.8008},1,cjs.Ease.get(1)).to({regX:-0.6,regY:0.5,scaleX:0.0844,scaleY:0.2323,rotation:2.4361,x:-77.8,y:357.3,alpha:1},9).wait(1).to({regX:0,regY:1.8,scaleX:0.0845,scaleY:0.2319,rotation:2.4291,x:-77.7,y:357.8},0).wait(1).to({scaleY:0.2309,rotation:2.4068,x:-77.65,y:358.45},0).wait(1).to({scaleX:0.0846,scaleY:0.229,rotation:2.3666,x:-77.6,y:359.55},0).wait(1).to({scaleX:0.0848,scaleY:0.2262,rotation:2.3056,x:-77.45,y:361.2},0).wait(1).to({scaleX:0.085,scaleY:0.2222,rotation:2.2203,x:-77.25,y:363.5},0).wait(1).to({scaleX:0.0854,scaleY:0.2169,rotation:2.1072,x:-76.85,y:366.55},0).wait(1).to({scaleX:0.0858,scaleY:0.2102,rotation:1.963,x:-76.25,y:370.45},0).wait(1).to({scaleX:0.0863,scaleY:0.202,rotation:1.7865,x:-75.1,y:375.55},0).wait(1).to({scaleX:0.0868,scaleY:0.1924,rotation:1.5814,x:-73.85,y:380.7},0).wait(1).to({scaleX:0.0874,scaleY:0.182,rotation:1.3584,x:-72.3,y:386.3},0).wait(1).to({scaleX:0.0881,scaleY:0.1716,rotation:1.1353,x:-70.45,y:391.95},0).wait(1).to({scaleX:0.0886,scaleY:0.1621,rotation:0.9304,x:-68.3,y:397.2},0).wait(1).to({scaleX:0.0891,scaleY:0.154,rotation:0.756,x:-65.65,y:402.35},0).wait(1).to({scaleX:0.0895,scaleY:0.1475,rotation:0.6164,x:-62.7,y:407.25},0).wait(1).to({scaleX:0.0898,scaleY:0.1425,rotation:0.5106,x:-60.55,y:410.55},0).wait(1).to({scaleX:0.09,scaleY:0.139,rotation:0.435,x:-59.1,y:412.7},0).wait(1).to({scaleX:0.0902,scaleY:0.1367,rotation:0.3855,x:-58.2,y:414},0).wait(1).to({scaleY:0.1354,rotation:0.3581,x:-57.7,y:414.7},0).wait(1).to({regY:0.4,scaleX:0.0903,scaleY:0.135,rotation:0.3497,x:-57.6,y:414.75},0).to({regX:-0.9,regY:1,scaleX:0.0601,scaleY:0.1464,rotation:-1.9418,x:-56.2,y:458.65},6,cjs.Ease.get(-1)).to({_off:true},1).wait(83).to({_off:false,regX:0,regY:0,scaleX:0.092,scaleY:0.2103,rotation:30.0006,x:-506.85,y:427.15,alpha:0},0).to({scaleX:0.0913,scaleY:0.2087,rotation:27.1364,x:-513.65,y:453.4,alpha:1},4).wait(1).to({regY:1.8,scaleY:0.2085,rotation:27.2153,x:-513.85,y:454},0).wait(1).to({scaleY:0.2077,rotation:27.4685,x:-514.15,y:454.8},0).wait(1).to({scaleY:0.2063,rotation:27.924,x:-514.65,y:456.25},0).wait(1).to({scaleY:0.2041,rotation:28.6154,x:-515.55,y:458.35},0).wait(1).to({scaleX:0.0912,scaleY:0.2011,rotation:29.5814,x:-516.7,y:461.4},0).wait(1).to({scaleY:0.1971,rotation:30.8633,x:-518.35,y:465.45},0).wait(1).to({scaleX:0.0911,scaleY:0.192,rotation:32.4973,x:-520.55,y:470.5},0).wait(1).to({scaleX:0.091,scaleY:0.1858,rotation:34.4966,x:-523.45,y:476.65},0).wait(1).to({scaleX:0.0909,scaleY:0.1785,rotation:36.8212,x:-527.05,y:483.6},0).wait(1).to({scaleX:0.0908,scaleY:0.1707,rotation:39.3476,x:-531.3,y:491},0).wait(1).to({scaleX:0.0907,scaleY:0.1628,rotation:41.8758,x:-535.6,y:497.85},0).wait(1).to({scaleX:0.0906,scaleY:0.1555,rotation:44.1978,x:-539.5,y:503.45},0).wait(1).to({scaleX:0.0905,scaleY:0.1494,rotation:46.1742,x:-543.15,y:508.25},0).wait(1).to({scaleX:0.0904,scaleY:0.1445,rotation:47.7555,x:-546.25,y:511.95},0).wait(1).to({scaleY:0.1407,rotation:48.9543,x:-548.8,y:514.8},0).wait(1).to({scaleX:0.0903,scaleY:0.1381,rotation:49.8109,x:-550.75,y:516.75},0).wait(1).to({scaleY:0.1363,rotation:50.3723,x:-552.05,y:518.05},0).wait(1).to({scaleY:0.1353,rotation:50.6821,x:-552.8,y:518.8},0).wait(1).to({regY:0,scaleY:0.135,rotation:50.778,x:-552.85,y:518.9},0).to({x:-552.9,y:562.95},6,cjs.Ease.get(-1)).to({y:565.15,alpha:0.5},1,cjs.Ease.get(1)).to({_off:true},1).wait(62));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-554.7,0,499.70000000000005,567);
...
(lib.book_1 = function(mode,startPosition,loop) {
	...
	this.drop.setTransform(269.35,313.3,1,1,0,0,0,-133.1,427.4);
	...
	this.instance.parent = this;
	this.instance.setTransform(190,108,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.book_1, new cjs.Rectangle(190,108,380,216), null);
...
(lib.tie = function(mode,startPosition,loop) {
	...
	// txt
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("Ag4BJIAAiOIATAAIAAAqIAPAEIAUAHIAUAHIAVAIIASAGIgIATIgdgNIgdgLIgcgJIAABSgAAQgiIgJgJIgIgIIAIgHIAIAHIAKAJIAIAIIgJAJIgIgJgAAhgxIgJgJIgJgHIAJgHIAIAGIAKAJIAIAIIgJAIIgIgIg");
	this.shape.setTransform(73.075,0.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("AAGBHIAAhLQgOAJgPAIIgeAMIgOgPQAmgLAdgUQAfgUAUgdIASAJQgLAOgLAKQgLALgLAJIAAAOIAAARIAAAVIAAAUIAAAQg");
	this.shape_1.setTransform(55.6,0.45);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("AgoA3QAUgDANgHQAMgGAHgKQAHgJADgMQACgLAAgPIAAgCIgvAAIAAAnIgRAAIAAgnIghAAIAAgRIAhAAIAAggIARAAIAAAgIAvAAIAAgPIAAgRIARAAIAAAQIAAAQIAhAAIAAARIghAAIAAADQAAAXgGARQgHARgPAMQgNAMgaAGg");
	this.shape_2.setTransform(40.05,0.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("AhLA6QALgJAIgMQAHgLAFgOQADgMABgOQACgOAAgOIAAgMIgBgMIASAAIAAALQAAAdgCAWQgDAVgIASQgIASgQAPgAAAAgIAAggIAAhDIARAAIAAAMIAAARIAAAVIgBAVIAAAVIAAAPQAMgFAIgKQAJgJAHgMQAGgLAFgMIANAPQgFAJgGAMQgIALgJAKQgKAKgMAIQgMAHgOADIAAgig");
	this.shape_3.setTransform(24.15,0.525);
	...
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#333333").s().p("");
	this.shape_5.setTransform(-7.15,-0.025);
	...
	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#333333").s().p("");
	this.shape_7.setTransform(-40.1,0.4);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#333333").s().p("");
	this.shape_8.setTransform(-55.875,0.975);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#333333").s().p("");
	this.shape_9.setTransform(-72.025,0.65);
...
(lib.character1_face = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("AsVMWIAA4rIYrAAIAAYrg");
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).wait(9));

	// body
	this.b = new lib.character1_base();
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-170,222);
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.face_blink_ary = [0, 1, 1, 1, 1, 0, 1, 1, 1, 0, 0, 1, 1, 1, 1]; 
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:76.5136,y:73.2237}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
...
p.nominalBounds = new cjs.Rectangle(-290,-174,640,700);
...
(lib.character1_body = function(mode,startPosition,loop) {
	...
	this.f.name = "f";
	this.f.parent = this;
	this.f.setTransform(71.1,-337.55);
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-98.9,-115.55);

	this.timeline.addTween(cjs.Tween.get(this.b).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-218.9,-511.5,640,700);
...
(lib.character1_container = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(7).call(this.frame_7).wait(1).call(this.frame_8).wait(7).call(this.frame_15).wait(1).call(this.frame_16).wait(8).call(this.frame_24).wait(1).call(this.frame_25).wait(11).call(this.frame_36).wait(1).call(this.frame_37).wait(9).call(this.frame_46).wait(1).call(this.frame_47).wait(9).call(this.frame_56).wait(1).call(this.frame_57).wait(8).call(this.frame_65).wait(1).call(this.frame_66).wait(14).call(this.frame_80).wait(1).call(this.frame_81).wait(10).call(this.frame_91).wait(1).call(this.frame_92).wait(19).call(this.frame_111).wait(1).call(this.frame_112).wait(8).call(this.frame_120).wait(1).call(this.frame_121).wait(10).call(this.frame_131).wait(1).call(this.frame_132).wait(13).call(this.frame_145).wait(1).call(this.frame_146).wait(13).call(this.frame_159).wait(1).call(this.frame_160).wait(20).call(this.frame_180).wait(1).call(this.frame_181).wait(19).call(this.frame_200).wait(1).call(this.frame_201).wait(27).call(this.frame_228).wait(1).call(this.frame_229).wait(11).call(this.frame_240).wait(1).call(this.frame_241).wait(10).call(this.frame_251).wait(1).call(this.frame_252).wait(15).call(this.frame_267).wait(1).call(this.frame_268).wait(26).call(this.frame_294).wait(1).call(this.frame_295).wait(17).call(this.frame_312).wait(1).call(this.frame_313).wait(11).call(this.frame_324).wait(1).call(this.frame_325).wait(17).call(this.frame_342).wait(1).call(this.frame_343).wait(6).call(this.frame_349).wait(1).call(this.frame_350).wait(18).call(this.frame_368).wait(1).call(this.frame_369).wait(14).call(this.frame_383).wait(1).call(this.frame_384).wait(19).call(this.frame_403).wait(1).call(this.frame_404).wait(11).call(this.frame_415).wait(1).call(this.frame_416).wait(16).call(this.frame_432).wait(1).call(this.frame_433).wait(8).call(this.frame_441).wait(1).call(this.frame_442).wait(23).call(this.frame_465).wait(1).call(this.frame_466).wait(12).call(this.frame_478).wait(1));

	// effect2
	this.instance = new lib.drop1_v2("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(94.15,-347.1,1.1645,1.1645);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(313).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:68.5,y:-356.1,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:56.9,y:-360.4,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:94.15,y:-347.1,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:68.5,y:-356.1,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:56.9,y:-360.4,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,rotation:0,x:94.15,y:-347.1,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:68.5,y:-356.1,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:56.9,y:-360.4,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:94.15,y:-347.1,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:68.5,y:-356.1,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:56.9,y:-360.4,alpha:0.2188},0).to({_off:true},1).wait(147));

	// effect
	this.instance_1 = new lib.spread_flower_pink("synched",0,false);
	this.instance_1.parent = this;
	this.instance_1.setTransform(148.3,-252.95,1.4808,1.4808);

	this.instance_2 = new lib.good_effect("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(148.3,-252.95,1.481,1.481);

	this.instance_3 = new lib.notice();
	this.instance_3.parent = this;
	this.instance_3.setTransform(76.6,-343,1.187,1.187,0,-169.8305,10.1695,-29.1,20.4);
	this.instance_3._off = true;

	this.instance_4 = new lib.laugh("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(55.7,-337.7,1.4204,1.4204,35.8424,0,0,-30.3,20.6);
	this.instance_4._off = true;

	this.instance_5 = new lib.chord("synched",0,false);
	this.instance_5.parent = this;
	this.instance_5.setTransform(83.5,-255.35,1.0029,1.0029,-61.4995,0,0,-23.4,76.9);

	this.instance_6 = new lib.question();
	this.instance_6.parent = this;
	this.instance_6.setTransform(82.85,-339.95,1.053,1.053,-28.4906);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.instance_7 = new lib.mc_exclamation("synched",0,false);
	this.instance_7.parent = this;
	this.instance_7.setTransform(80.6,-354.65,1.0929,1.0929,-29.9996,0,0,0,0.1);

	this.instance_8 = new lib.drop1a("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(86.1,-336.05,1,1,0,0,0,-0.5,0.2);
	this.instance_8._off = true;

	this.instance_9 = new lib.drop2_v2("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(92.35,-337.35,0.9876,0.9876,14.9998);
	this.instance_9._off = true;

	this.instance_10 = new lib.shock("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(82.75,-341,1.3878,1.3878,-121.2396);

	this.instance_11 = new lib.sigh("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(105.25,-186.6);
	this.instance_11.alpha = 0.6016;
	this.instance_11._off = true;

	this.instance_12 = new lib.heart("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(83.45,-296.2,0.4532,0.4532);
	this.instance_12._off = true;

	this.instance_13 = new lib.angry("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(221.4,-316.3,0.5276,0.5276);
	this.instance_13._off = true;

	this.instance_14 = new lib.mc_punpun();
	this.instance_14.parent = this;
	this.instance_14.setTransform(90.35,-365.45,1.1377,1.1377);

	this.instance_15 = new lib.concent_wrapper("synched",0,false);
	this.instance_15.parent = this;
	this.instance_15.setTransform(148.05,-253.5,1,1,0,0,0,-0.5,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1}]},37).to({state:[{t:this.instance_2}]},10).to({state:[]},10).to({state:[{t:this.instance_3}]},76).to({state:[]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[]},1).to({state:[{t:this.instance_3}]},2).to({state:[]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},15).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},20).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},7).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_6}]},6).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_7}]},5).to({state:[{t:this.instance_8}]},16).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},9).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},24).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},5).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},11).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},3).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_12}]},11).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},2).to({state:[{t:this.instance_12}]},3).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[]},1).to({state:[{t:this.instance_13}]},6).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},5).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[]},1).to({state:[{t:this.instance_14}]},2).to({state:[]},12).to({state:[{t:this.instance_15}]},17).to({state:[]},9).to({state:[{t:this.instance_1}]},24).wait(13));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(133).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:76.95,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:76.6,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,alpha:1},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:76.95,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:76.6,alpha:0},0).to({_off:true},1).wait(320));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(160).to({_off:false},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,scaleX:1.4203,scaleY:1.4203,x:53.15,y:-336.85,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.3,regY:20.6,scaleX:1.4204,scaleY:1.4204,x:55.7,y:-337.7,alpha:0,startPosition:19},0).to({_off:true},1).wait(299));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(202).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:75.85,y:-353.35,alpha:0.5556},0).wait(1).to({x:71.75,y:-361.6,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:70.5,y:-364.65,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:70.7,y:-363.7},0).wait(1).to({x:71.75,y:-361.85},0).wait(1).to({x:73.4,y:-358.7},0).wait(1).to({regX:0,regY:0,x:75.9,y:-354.65},0).to({x:75.15,y:-356},2).wait(8).to({regX:-0.2,regY:0.2,x:75.35,y:-355.1,alpha:0.9298},0).wait(1).to({x:76.4,y:-353.15,alpha:0.692},0).wait(1).to({x:78,y:-350.25,alpha:0.339},0).wait(1).to({x:79.15,y:-348.1,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:79.65,y:-347.8,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:82.4,y:-339.55},0).wait(1).to({regX:-0.2,regY:0.2,x:75.4,y:-352.95,alpha:0.5556},0).wait(1).to({x:71.3,y:-361.2,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:70.05,y:-364.25,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:70.25,y:-363.3},0).wait(1).to({x:71.3,y:-361.45},0).wait(1).to({x:72.95,y:-358.3},0).wait(1).to({regX:0,regY:0,x:75.45,y:-354.25},0).to({x:74.7,y:-355.6},2).wait(3).to({regX:-0.2,regY:0.2,x:74.9,y:-354.7,alpha:0.9298},0).wait(1).to({x:75.95,y:-352.75,alpha:0.692},0).wait(1).to({x:77.55,y:-349.85,alpha:0.339},0).wait(1).to({x:78.7,y:-347.7,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:79.2,y:-347.4,alpha:0},0).to({_off:true},1).wait(232));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(268).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:87.1,y:-332.35},0).wait(1).to({y:-328.5},0).wait(1).to({y:-325.25},0).wait(1).to({y:-322.6},0).wait(1).to({y:-320.5},0).wait(1).to({y:-319},0).wait(1).to({y:-318.1},0).wait(1).to({regX:-0.5,regY:0.2,x:86.1,y:-317.05},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:87.1,y:-317.85,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:86.1,y:-317.05,alpha:0},0).to({_off:true},1).wait(190));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(313).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:60.925,y:-332.7375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:50.45,y:-331.2,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:92.35,y:-337.35,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:60.925,y:-337.125,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:50.45,y:-337.05,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:92.35,y:-337.35,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:60.925,y:-332.7375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:50.45,y:-331.2,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:92.35,y:-337.35,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:60.925,y:-337.125,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:50.45,y:-337.05,alpha:0.2188},0).to({_off:true},1).wait(147));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(351).to({_off:false},0).wait(1).to({x:104.25,y:-185.6,alpha:1},0).wait(1).to({regX:0.9,x:104.1,y:-184.65,alpha:0.8965},0).wait(1).to({x:102.75,y:-183.45,alpha:0.7636},0).wait(1).to({x:101.15,y:-182,alpha:0.6048},0).wait(1).to({x:99.35,y:-180.4,alpha:0.4229},0).wait(1).to({x:97.35,y:-178.55,alpha:0.2205},0).wait(1).to({regX:0,x:94.25,y:-176.6,alpha:0},0).to({_off:true},1).wait(120));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:81.7,y:-310.35},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:78.45,y:-316.2},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:80.95,y:-314.05},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:81.5,y:-310.8},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:80.45,y:-306.2},0).to({scaleX:1,scaleY:1,x:79.45,y:-310.2},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:82.05,y:-309.2,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:80.45,y:-309.95,alpha:0.1016},0).to({_off:true},1).wait(96));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(389).to({_off:false},0).wait(1).to({scaleX:1.0714,scaleY:1.0714,y:-320.05},0).wait(1).to({scaleX:1.2527,scaleY:1.2527,y:-321.3},0).wait(1).to({scaleX:0.9864,scaleY:0.9864},0).wait(1).to({scaleX:0.8976,scaleY:0.8976},0).wait(5).to({startPosition:0},0).wait(1).to({alpha:0.5009},0).wait(1).to({alpha:0.2014},0).wait(1).to({alpha:0.1016},0).to({_off:true},1).wait(77));
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:101.1,regY:-161.6,x:101.1,y:-170},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-170.8},0).wait(1).to({y:-168.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-167.1},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-167.35},0).wait(1).to({y:-160.4},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-158.35},0).wait(1).to({y:-160.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-166.55},0).wait(1).to({y:-160.65},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-166.55},0).wait(1).to({y:-160.65},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-160.7},0).wait(1).to({y:-161.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-170.6},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-174.55},0).wait(1).to({y:-170.95},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-159.6},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-161.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-170.6},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-174.55},0).wait(1).to({y:-170.95},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-159.6},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-161.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:101.1,regY:-161.6,x:101.1,y:-161},0).wait(1).to({y:-158.6},0).wait(1).to({y:-156.25},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-156.25},0).wait(1).to({y:-158.6},0).wait(1).to({y:-161},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:101.1,regY:-161.6,x:101.1,y:-161.45},0).wait(1).to({y:-160.9},0).wait(1).to({y:-159.8},0).wait(1).to({y:-158.45},0).wait(1).to({y:-157.35},0).wait(1).to({y:-156.8},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-156.8},0).wait(1).to({y:-157.35},0).wait(1).to({y:-158.45},0).wait(1).to({y:-159.8},0).wait(1).to({y:-160.9},0).wait(1).to({y:-161.45},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-156.85},0).wait(1).to({y:-160.4},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-159.4},0).wait(1).to({y:-161.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:101.1,regY:-161.6,rotation:-0.0253,x:101.05,y:-161.6},0).wait(1).to({rotation:-0.1129,x:100.9,y:-161.45},0).wait(1).to({rotation:-0.2845,x:100.65,y:-161.2},0).wait(1).to({rotation:-0.5565,x:100.25,y:-160.85},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:99.7,y:-160.3},0).wait(1).to({rotation:-1.2075,x:99.2,y:-159.85},0).wait(1).to({rotation:-1.4141,x:98.85,y:-159.5},0).wait(1).to({rotation:-1.5201,x:98.7,y:-159.3},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(1).to({regX:101.1,regY:-161.6,rotation:-1.5305,x:98.7,y:-159.3},0).wait(1).to({rotation:-1.4624,x:98.8,y:-159.45},0).wait(1).to({rotation:-1.3309,x:99,y:-159.65},0).wait(1).to({rotation:-1.121,x:99.3,y:-160},0).wait(1).to({rotation:-0.8372,x:99.8,y:-160.4},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:100.25,y:-160.9},0).wait(1).to({rotation:-0.2881,x:100.6,y:-161.25},0).wait(1).to({rotation:-0.1291,x:100.85,y:-161.55},0).wait(1).to({rotation:-0.0467,x:100.95,y:-161.65},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:101.1,regY:-161.6,rotation:-0.0253,x:101.05,y:-161.6},0).wait(1).to({rotation:-0.1129,x:100.9,y:-161.45},0).wait(1).to({rotation:-0.2845,x:100.65,y:-161.2},0).wait(1).to({rotation:-0.5565,x:100.25,y:-160.85},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:99.7,y:-160.3},0).wait(1).to({rotation:-1.2075,x:99.2,y:-159.85},0).wait(1).to({rotation:-1.4141,x:98.85,y:-159.5},0).wait(1).to({rotation:-1.5201,x:98.7,y:-159.3},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(1).to({regX:101.1,regY:-161.6,rotation:-1.5302,x:98.7,y:-159.3},0).wait(1).to({rotation:-1.461,x:98.8,y:-159.45},0).wait(1).to({rotation:-1.3276,x:99,y:-159.65},0).wait(1).to({rotation:-1.1146,x:99.3,y:-159.95},0).wait(1).to({rotation:-0.8266,x:99.8,y:-160.35},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.5189,x:100.3,y:-160.85},0).wait(1).to({rotation:-0.2693,x:100.65,y:-161.25},0).wait(1).to({rotation:-0.1079,x:100.9,y:-161.5},0).wait(1).to({rotation:-0.0243,x:101.05,y:-161.6},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:101.1,regY:-161.6,x:101.1,y:-167.15},0).wait(1).to({y:-169.05},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-168.95},0).wait(1).to({y:-166.85},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:101.1,regY:-161.6,x:101.1,y:-170},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-170.8},0).wait(1).to({y:-168.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(15).to({regX:101.1,regY:-161.6,rotation:-0.0253,x:101.05,y:-161.55},0).wait(1).to({rotation:-0.1129,x:100.9,y:-161.15},0).wait(1).to({rotation:-0.2845,x:100.65,y:-160.45},0).wait(1).to({rotation:-0.5565,x:100.25,y:-159.4},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:99.7,y:-157.95},0).wait(1).to({rotation:-1.2075,x:99.2,y:-156.7},0).wait(1).to({rotation:-1.4141,x:98.85,y:-155.85},0).wait(1).to({rotation:-1.5201,x:98.7,y:-155.4},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:9},0).wait(1).to({regX:101.1,regY:-161.6,rotation:-1.5305,x:98.7,y:-155.35},0).wait(1).to({rotation:-1.4624,x:98.8,y:-155.7},0).wait(1).to({rotation:-1.3309,x:99,y:-156.2},0).wait(1).to({rotation:-1.121,x:99.3,y:-157.1},0).wait(1).to({rotation:-0.8372,x:99.8,y:-158.3},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:100.25,y:-159.55},0).wait(1).to({rotation:-0.2881,x:100.6,y:-160.55},0).wait(1).to({rotation:-0.1291,x:100.85,y:-161.25},0).wait(1).to({rotation:-0.0467,x:100.95,y:-161.6},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:101.1,regY:-161.6,rotation:-0.147,x:100.85,y:-161.4},0).wait(1).to({rotation:-0.7239,x:99.95,y:-160.6},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.3727,x:98.95,y:-159.55},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(18).to({regX:101.1,regY:-161.6,rotation:-1.4913,x:98.75,y:-159.4},0).wait(1).to({rotation:-1.2701,x:99.05,y:-159.75},0).wait(1).to({rotation:-0.8372,x:99.8,y:-160.4},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:100.5,y:-161.15},0).wait(1).to({rotation:-0.094,x:100.9,y:-161.55},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:101.1,regY:-161.6,rotation:-0.0894,x:100.95,y:-161.5},0).wait(1).to({rotation:-0.4358,x:100.4,y:-160.95},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.0316,x:99.5,y:-160.05},0).wait(1).to({rotation:-1.4426,x:98.85,y:-159.45},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(8).to({regX:101.1,regY:-161.6,rotation:-1.4913,x:98.75,y:-159.4},0).wait(1).to({rotation:-1.2701,x:99.05,y:-159.75},0).wait(1).to({rotation:-0.8372,x:99.8,y:-160.4},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:100.5,y:-161.15},0).wait(1).to({rotation:-0.094,x:100.9,y:-161.55},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-170},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-170.8},0).wait(1).to({y:-168.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:101.1,regY:-161.6,x:98.35,y:-153.85},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:101.1,regY:-161.6,x:101.1,y:-149.35},0).wait(1).to({y:-152.3},0).wait(1).to({y:-157.25},0).wait(1).to({y:-160.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-160.6},0).wait(1).to({y:-154.65},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:101.1,regY:-161.6,x:101.1,y:-153.8},0).wait(1).to({y:-158.1},0).wait(1).to({y:-162.4},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-162.1},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:101.1,regY:-161.6,x:101.1,y:-168.3},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-168.45},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-170},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-170.8},0).wait(1).to({y:-168.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:101.1,regY:-161.6,x:98.35,y:-153.85},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:101.1,regY:-161.6,x:101.1,y:-150.85},0).wait(1).to({y:-158.6},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-162.6},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-161.75},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-161.1},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:101.1,regY:-161.6,x:101.1,y:-161},0).wait(1).to({y:-158.6},0).wait(1).to({y:-156.25},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-156.2},0).wait(1).to({y:-156.5},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:101.1,regY:-161.6,x:101.1,y:-157},0).wait(1).to({y:-158.5},0).wait(1).to({y:-160.75},0).wait(1).to({y:-162.2},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-161.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-169.2},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-170.8},0).wait(1).to({y:-168.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:101.1,regY:-161.6,x:101.1,y:-169.1},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:101.1,regY:-161.6,x:101.1,y:-169.6},0).wait(1).to({y:-163.6},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:101.1,regY:-161.6,x:101.1,y:-156.95},0).wait(1).to({y:-158.15},0).wait(1).to({y:-160.1},0).wait(1).to({y:-161.3},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-166.55},0).wait(1).to({y:-160.65},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-166.55},0).wait(1).to({y:-160.65},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:101.1,regY:-161.6,x:101.1,y:-160.7},0).wait(1).to({y:-161.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:101.1,regY:-161.6,x:104.1,y:-158.2},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:101.1,regY:-161.6,x:100.25,y:-152.15},0).wait(1).to({x:100.9,y:-151.75},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:101.1,regY:-161.6,x:101.1,y:-152.3},0).wait(1).to({y:-154.75},0).wait(1).to({y:-158.45},0).wait(1).to({y:-160.95},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(10).to({regX:-0.1,regY:0.1,scaleX:1.0099,scaleY:1.0099,rotation:-0.9982,x:0.15,y:3.35},0).to({regX:0.3,scaleX:0.9899,scaleY:0.99,rotation:0.7666,x:6.65,y:-2.1},9,cjs.Ease.cubicOut).to({regX:0,regY:0,scaleX:1,scaleY:1,rotation:0,x:0,y:0},13,cjs.Ease.quadOut).wait(15));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-456.9,-680.4,1012.6,884.8);
...
// stage content:
(lib._413_4 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:171,scene2:172,end2:318,scene3:319,end3:477,scene4:478,end4:578,scene5:579,end5:731,scene6:732,end6:886,scene7:887,end7:1025});
	...
	this.frame_15 = function() {
		...
		this.ch1.gotoAndPlay("confortable");
	}
	this.frame_37 = function() {
	...
	this.frame_233 = function() {
		exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
		exportRoot._g.m3 = "くって!";
		exportRoot._u.setText();
	}
	this.frame_237 = function() {
		this.book1.drop.gotoAndPlay(1);
	}
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(11).call(this.frame_11).wait(3).call(this.frame_14).wait(1).call(this.frame_15).wait(22).call(this.frame_37).wait(34).call(this.frame_71).wait(40).call(this.frame_111).wait(24).call(this.frame_135).wait(36).call(this.frame_171).wait(1).call(this.frame_172).wait(19).call(this.frame_191).wait(42).call(this.frame_233).wait(4).call(this.frame_237).wait(28).call(this.frame_265).wait(29).call(this.frame_294).wait(24).call(this.frame_318).wait(1).call(this.frame_319).wait(24).call(this.frame_343).wait(48).call(this.frame_391).wait(17).call(this.frame_408).wait(27).call(this.frame_435).wait(14).call(this.frame_449).wait(28).call(this.frame_477).wait(1).call(this.frame_478).wait(22).call(this.frame_500).wait(37).call(this.frame_537).wait(20).call(this.frame_557).wait(21).call(this.frame_578).wait(1).call(this.frame_579).wait(20).call(this.frame_599).wait(23).call(this.frame_622).wait(25).call(this.frame_647).wait(47).call(this.frame_694).wait(22).call(this.frame_716).wait(15).call(this.frame_731).wait(1).call(this.frame_732).wait(11).call(this.frame_743).wait(30).call(this.frame_773).wait(23).call(this.frame_796).wait(44).call(this.frame_840).wait(18).call(this.frame_858).wait(28).call(this.frame_886).wait(1).call(this.frame_887).wait(22).call(this.frame_909).wait(18).call(this.frame_927).wait(30).call(this.frame_957).wait(27).call(this.frame_984).wait(15).call(this.frame_999).wait(26).call(this.frame_1025).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.sender).wait(1025).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.loader).wait(1030));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},3,cjs.Ease.get(1)).to({_off:true},1).wait(1011));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},3).wait(1015));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2).to({alpha:0.1016},3).to({_off:true},1).wait(1024));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(944).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(46));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},984).wait(46));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(984).to({_off:false},0).wait(46));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(984).to({_off:false},0).wait(46));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(972).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(46));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(15).to({alpha:0},3).to({_off:true},1).wait(207).to({_off:false},0).to({alpha:1},7).to({alpha:0},6).to({_off:true},1).wait(46).to({_off:false},0).to({alpha:1},6).to({alpha:0},6).to({_off:true},1).wait(588).to({_off:false,alpha:1},0).to({alpha:0},7).to({_off:true},1).wait(135));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12},{t:this.instance_11}]}).to({state:[]},15).wait(1015));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(233).to({_off:false},0).to({_off:true},59).wait(738));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(233).to({_off:false},0).to({_off:true},59).wait(738));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(15).to({_off:false},0).wait(1015));

	// book2
	this.book2 = new lib.book_1();
	this.book2.name = "book2";
	this.book2.parent = this;
	this.book2.setTransform(-901.15,387.9,0.8396,0.8396,0,0,0,379.9,216.4);
	this.book2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.book2).wait(319).to({_off:false},0).wait(159).to({x:192.4},0).to({scaleX:0.8646,scaleY:0.8646,x:194.7,y:396.75},22,cjs.Ease.cubicInOut).wait(232).to({regY:216.5,scaleX:0.9741,scaleY:0.9741,x:205.5,y:434.95},40,cjs.Ease.cubicInOut).wait(115).to({regX:379.4,regY:216.7,scaleX:0.5415,scaleY:0.5415,x:172.15,y:287.3},0).to({_off:true},97).wait(46));

	// ch2
	this.ch2 = new lib.character1_container();
	this.ch2.name = "ch2";
	this.ch2.parent = this;
	this.ch2.setTransform(-1094.75,320.35,0.8396,0.8396,0,0,0,0.4,0.4);
	this.ch2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.ch2).wait(319).to({_off:false},0).wait(159).to({x:-1.2},0).to({regY:0.5,scaleX:0.8646,scaleY:0.8646,x:-5.05,y:327.3},22,cjs.Ease.cubicInOut).wait(232).to({regX:0.3,scaleX:0.9741,scaleY:0.9741,x:-19.7,y:356.6},40,cjs.Ease.cubicInOut).wait(115).to({regX:0.9,regY:1.2,scaleX:0.5415,scaleY:0.5415,x:47.05,y:243.9},0).to({_off:true},97).wait(46));

	// bg2
	this.bg2 = new lib.bg_zoom_half();
	this.bg2.name = "bg2";
	this.bg2.parent = this;
	this.bg2.setTransform(-1279.4,-109.9,0.8396,0.8396,0,0,0,-0.6,-0.5);
	this.bg2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.bg2).wait(319).to({_off:false},0).wait(159).to({x:-185.85},0).to({scaleX:0.8646,scaleY:0.8646,x:-194.55,y:-115.2},22,cjs.Ease.cubicInOut).wait(232).to({regX:-0.7,scaleX:0.9741,scaleY:0.9741,x:-233.15,y:-141.8},40,cjs.Ease.cubicInOut).wait(115).to({regX:-1.3,regY:-1.2,scaleX:0.5415,scaleY:0.5415,x:-71.7,y:-33.35},0).to({_off:true},97).wait(46));

	// book
	this.book1 = new lib.book_1();
	this.book1.name = "book1";
	this.book1.parent = this;
	this.book1.setTransform(360.25,512.1,1,1,0,0,0,380.1,216.1);

	this.timeline.addTween(cjs.Tween.get(this.book1).wait(15).to({regY:216,scaleX:0.7587,scaleY:0.7587,x:203,y:376.1},0).to({x:195.5},22,cjs.Ease.cubicOut).wait(34).to({regY:216.2,scaleX:0.5365,scaleY:0.5365,x:206.7,y:284.5},33,cjs.Ease.cubicInOut).wait(68).to({x:167.95},23,cjs.Ease.cubicInOut).wait(38).to({regX:380,regY:215.9,scaleX:0.8329,scaleY:0.8329,x:121.35,y:104.9},0).to({x:103.95},59).wait(1).to({regX:380.1,regY:216.2,scaleX:0.5365,scaleY:0.5365,x:167.95,y:284.5},0).wait(26).to({regX:380,regY:216.3,scaleX:0.5873,scaleY:0.5873,x:173.3,y:301.2},24,cjs.Ease.cubicInOut).wait(92).to({alpha:0.0117},11,cjs.Ease.quadOut).to({_off:true},1).wait(583));
	...
	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({scaleX:0.7587,scaleY:0.7587,x:27.55,y:315.05},0).to({x:20.05},22,cjs.Ease.cubicOut).wait(34).to({regX:0.3,regY:0.3,scaleX:0.5365,scaleY:0.5365,x:82.7,y:241.35},33,cjs.Ease.cubicInOut).wait(68).to({x:43.95},23,cjs.Ease.cubicInOut).wait(38).to({regX:-0.1,regY:0.1,scaleX:0.8329,scaleY:0.8329,x:-71.2,y:37.95},0).to({x:-88.6},59).wait(1).to({regX:0.3,regY:0.3,scaleX:0.5365,scaleY:0.5365,x:43.95,y:241.35},0).wait(26).to({regX:0.5,regY:0.4,scaleX:0.5873,scaleY:0.5873,x:37.65,y:254.05},24,cjs.Ease.cubicInOut).wait(92).to({alpha:0.0117},11,cjs.Ease.quadOut).to({_off:true},1).wait(583));

	// bg
	this.bg1 = new lib.bg_zoom_half();
	this.bg1.name = "bg1";
	this.bg1.parent = this;
	this.bg1.setTransform(-89.85,-80);

	this.timeline.addTween(cjs.Tween.get(this.bg1).wait(15).to({regX:-0.1,regY:-0.1,scaleX:0.7587,scaleY:0.7587,x:-138.55,y:-73.1},0).to({x:-146.05},22,cjs.Ease.cubicOut).wait(34).to({regX:-0.3,regY:-0.2,scaleX:0.5365,scaleY:0.5365,x:-34.8,y:-33.15},33,cjs.Ease.cubicInOut).wait(68).to({x:-73.55},23,cjs.Ease.cubicInOut).wait(38).to({regX:-0.1,regY:-0.1,scaleX:0.8329,scaleY:0.8329,x:-253.55,y:-388.15},0).to({x:-270.95},59).wait(1).to({regX:-0.3,regY:-0.2,scaleX:0.5365,scaleY:0.5365,x:-73.55,y:-33.15},0).wait(26).to({regX:-0.4,regY:-0.4,scaleX:0.5873,scaleY:0.5873,x:-91.1,y:-46.55},24,cjs.Ease.cubicInOut).wait(92).to({alpha:0.0117},11,cjs.Ease.quadOut).to({_off:true},1).wait(583));

	// book3
	this.book3 = new lib.book_1();
	this.book3.name = "book3";
	this.book3.parent = this;
	this.book3.setTransform(1542.45,465,0.8899,0.8899,0,0,0,570,324.1);
	this.book3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.book3).wait(318).to({_off:false},0).wait(117).to({x:514.55,y:325.9},0).wait(1).to({regX:380,regY:216,x:345.3,y:229.75},0).wait(1).to({scaleX:0.8898,scaleY:0.8898,x:344.9,y:230.05},0).wait(1).to({scaleX:0.8896,scaleY:0.8896,x:344.3,y:230.5},0).wait(1).to({scaleX:0.8893,scaleY:0.8893,x:343.4,y:231.15},0).wait(1).to({scaleX:0.889,scaleY:0.889,x:342.15,y:232},0).wait(1).to({scaleX:0.8885,scaleY:0.8885,x:340.65,y:233.1},0).wait(1).to({scaleX:0.8879,scaleY:0.8879,x:338.7,y:234.55},0).wait(1).to({scaleX:0.8873,scaleY:0.8873,x:336.4,y:236.25},0).wait(1).to({scaleX:0.8864,scaleY:0.8864,x:333.65,y:238.25},0).wait(1).to({scaleX:0.8855,scaleY:0.8855,x:330.45,y:240.7},0).wait(1).to({scaleX:0.8843,scaleY:0.8843,x:326.65,y:243.6},0).wait(1).to({scaleX:0.883,scaleY:0.883,x:322.25,y:246.95},0).wait(1).to({scaleX:0.8815,scaleY:0.8815,x:317.25,y:250.85},0).wait(1).to({scaleX:0.8798,scaleY:0.8798,x:311.6,y:255.4},0).wait(1).to({scaleX:0.8779,scaleY:0.8779,x:305.2,y:260.6},0).wait(1).to({scaleX:0.8757,scaleY:0.8757,x:298.1,y:266.55},0).wait(1).to({scaleX:0.8733,scaleY:0.8733,x:290.4,y:273.25},0).wait(1).to({scaleX:0.8707,scaleY:0.8707,x:282.15,y:280.65},0).wait(1).to({scaleX:0.868,scaleY:0.868,x:273.5,y:288.7},0).wait(1).to({scaleX:0.8652,scaleY:0.8652,x:264.7,y:297.2},0).wait(1).to({scaleX:0.8624,scaleY:0.8624,x:256.05,y:305.95},0).wait(1).to({scaleX:0.8596,scaleY:0.8596,x:247.75,y:314.75},0).wait(1).to({scaleX:0.857,scaleY:0.857,x:240.1,y:323.25},0).wait(1).to({scaleX:0.8546,scaleY:0.8546,x:233,y:331.45},0).wait(1).to({scaleX:0.8524,scaleY:0.8524,x:226.7,y:339.05},0).wait(1).to({scaleX:0.8505,scaleY:0.8505,x:221.2,y:346.05},0).wait(1).to({scaleX:0.8487,scaleY:0.8487,x:216.3,y:352.4},0).wait(1).to({scaleX:0.8472,scaleY:0.8472,x:212.1,y:358.1},0).wait(1).to({scaleX:0.8458,scaleY:0.8458,x:208.45,y:363.2},0).wait(1).to({scaleX:0.8446,scaleY:0.8446,x:205.35,y:367.7},0).wait(1).to({scaleX:0.8436,scaleY:0.8436,x:202.65,y:371.55},0).wait(1).to({scaleX:0.8428,scaleY:0.8428,x:200.4,y:375},0).wait(1).to({scaleX:0.842,scaleY:0.842,x:198.5,y:377.9},0).wait(1).to({scaleX:0.8414,scaleY:0.8414,x:196.95,y:380.35},0).wait(1).to({scaleX:0.8409,scaleY:0.8409,x:195.7,y:382.4},0).wait(1).to({scaleX:0.8405,scaleY:0.8405,x:194.6,y:384.05},0).wait(1).to({scaleX:0.8401,scaleY:0.8401,x:193.8,y:385.35},0).wait(1).to({scaleX:0.8399,scaleY:0.8399,x:193.2,y:386.3},0).wait(1).to({scaleX:0.8397,scaleY:0.8397,x:192.8,y:387},0).wait(1).to({scaleX:0.8396,scaleY:0.8396,x:192.55,y:387.35},0).wait(1).to({regX:570,regY:324,x:352,y:478.25},0).to({_off:true},2).wait(552));

	// ch3
	this.ch3 = new lib.character1_container();
	this.ch3.name = "ch3";
	this.ch3.parent = this;
	this.ch3.setTransform(1542.55,464.95,0.8899,0.8899,0,0,0,421.1,188.5);
	this.ch3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.ch3).wait(318).to({_off:false},0).wait(117).to({x:514.65,y:325.85},0).wait(1).to({regX:149.9,regY:-226.2,x:273.15,y:-43.1},0).wait(1).to({scaleX:0.8898,scaleY:0.8898,x:272.8,y:-42.8},0).wait(1).to({scaleX:0.8896,scaleY:0.8896,x:272.15,y:-42.3},0).wait(1).to({scaleX:0.8893,scaleY:0.8893,x:271.25,y:-41.55},0).wait(1).to({scaleX:0.889,scaleY:0.889,x:270.1,y:-40.6},0).wait(1).to({scaleX:0.8885,scaleY:0.8885,x:268.6,y:-39.35},0).wait(1).to({scaleX:0.888,scaleY:0.888,x:266.7,y:-37.75},0).wait(1).to({scaleX:0.8873,scaleY:0.8873,x:264.45,y:-35.85},0).wait(1).to({scaleX:0.8864,scaleY:0.8864,x:261.75,y:-33.55},0).wait(1).to({scaleX:0.8855,scaleY:0.8855,x:258.6,y:-30.8},0).wait(1).to({scaleX:0.8844,scaleY:0.8844,x:254.85,y:-27.6},0).wait(1).to({scaleX:0.883,scaleY:0.883,x:250.6,y:-23.85},0).wait(1).to({scaleX:0.8815,scaleY:0.8815,x:245.75,y:-19.45},0).wait(1).to({scaleX:0.8798,scaleY:0.8798,x:240.2,y:-14.35},0).wait(1).to({scaleX:0.8779,scaleY:0.8779,x:233.95,y:-8.6},0).wait(1).to({scaleX:0.8757,scaleY:0.8757,x:227.05,y:-2},0).wait(1).to({scaleX:0.8733,scaleY:0.8733,x:219.5,y:5.45},0).wait(1).to({scaleX:0.8707,scaleY:0.8707,x:211.45,y:13.65},0).wait(1).to({scaleX:0.868,scaleY:0.868,x:203,y:22.5},0).wait(1).to({scaleX:0.8652,scaleY:0.8652,x:194.5,y:31.9},0).wait(1).to({scaleX:0.8624,scaleY:0.8624,x:186.05,y:41.55},0).wait(1).to({scaleX:0.8597,scaleY:0.8597,x:178,y:51.15},0).wait(1).to({scaleX:0.8571,scaleY:0.8571,x:170.45,y:60.5},0).wait(1).to({scaleX:0.8547,scaleY:0.8547,x:163.65,y:69.4},0).wait(1).to({scaleX:0.8525,scaleY:0.8525,x:157.55,y:77.7},0).wait(1).to({scaleX:0.8505,scaleY:0.8505,x:152.15,y:85.25},0).wait(1).to({scaleX:0.8487,scaleY:0.8487,x:147.45,y:92.15},0).wait(1).to({scaleX:0.8472,scaleY:0.8472,x:143.3,y:98.3},0).wait(1).to({scaleX:0.8458,scaleY:0.8458,x:139.8,y:103.8},0).wait(1).to({scaleX:0.8447,scaleY:0.8447,x:136.75,y:108.7},0).wait(1).to({scaleX:0.8436,scaleY:0.8436,x:134.15,y:112.9},0).wait(1).to({scaleX:0.8428,scaleY:0.8428,x:132,y:116.55},0).wait(1).to({scaleX:0.842,scaleY:0.842,x:130.15,y:119.75},0).wait(1).to({scaleX:0.8414,scaleY:0.8414,x:128.65,y:122.4},0).wait(1).to({scaleX:0.8409,scaleY:0.8409,x:127.35,y:124.6},0).wait(1).to({scaleX:0.8405,scaleY:0.8405,x:126.4,y:126.35},0).wait(1).to({scaleX:0.8401,scaleY:0.8401,x:125.65,y:127.75},0).wait(1).to({scaleX:0.8399,scaleY:0.8399,x:125.05,y:128.8},0).wait(1).to({scaleX:0.8397,scaleY:0.8397,x:124.7,y:129.5},0).wait(1).to({scaleX:0.8396,scaleY:0.8396,x:124.45,y:129.9},0).wait(1).to({regX:421.2,regY:188.5,x:352.1,y:478.25},0).to({_off:true},2).wait(552));

	// bg3
	this.bg3 = new lib.bg_zoom_half();
	this.bg3.name = "bg3";
	this.bg3.parent = this;
	this.bg3.setTransform(1542.5,464.95,0.8899,0.8899,0,0,0,640,700.1);
	this.bg3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.bg3).wait(318).to({_off:false},0).wait(117).to({x:514.6,y:325.85},0).wait(1).to({regX:320,regY:350,x:229.7,y:14.45},0).wait(1).to({scaleX:0.8898,scaleY:0.8898,x:229.4,y:14.7},0).wait(1).to({scaleX:0.8896,scaleY:0.8896,x:228.75,y:15.2},0).wait(1).to({scaleX:0.8893,scaleY:0.8893,x:227.9,y:15.9},0).wait(1).to({scaleX:0.889,scaleY:0.889,x:226.7,y:16.9},0).wait(1).to({scaleX:0.8885,scaleY:0.8885,x:225.2,y:18.15},0).wait(1).to({scaleX:0.888,scaleY:0.888,x:223.35,y:19.7},0).wait(1).to({scaleX:0.8873,scaleY:0.8873,x:221.15,y:21.55},0).wait(1).to({scaleX:0.8864,scaleY:0.8864,x:218.45,y:23.75},0).wait(1).to({scaleX:0.8855,scaleY:0.8855,x:215.35,y:26.45},0).wait(1).to({scaleX:0.8844,scaleY:0.8844,x:211.7,y:29.55},0).wait(1).to({scaleX:0.883,scaleY:0.883,x:207.5,y:33.25},0).wait(1).to({scaleX:0.8815,scaleY:0.8815,x:202.7,y:37.55},0).wait(1).to({scaleX:0.8798,scaleY:0.8798,x:197.25,y:42.5},0).wait(1).to({scaleX:0.8779,scaleY:0.8779,x:191.1,y:48.15},0).wait(1).to({scaleX:0.8757,scaleY:0.8757,x:184.35,y:54.65},0).wait(1).to({scaleX:0.8733,scaleY:0.8733,x:176.9,y:61.9},0).wait(1).to({scaleX:0.8707,scaleY:0.8707,x:169,y:69.95},0).wait(1).to({scaleX:0.868,scaleY:0.868,x:160.65,y:78.65},0).wait(1).to({scaleX:0.8652,scaleY:0.8652,x:152.25,y:87.8},0).wait(1).to({scaleX:0.8624,scaleY:0.8624,x:143.95,y:97.3},0).wait(1).to({scaleX:0.8597,scaleY:0.8597,x:136.05,y:106.75},0).wait(1).to({scaleX:0.8571,scaleY:0.8571,x:128.65,y:115.9},0).wait(1).to({scaleX:0.8547,scaleY:0.8547,x:121.95,y:124.65},0).wait(1).to({scaleX:0.8525,scaleY:0.8525,x:115.95,y:132.75},0).wait(1).to({scaleX:0.8505,scaleY:0.8505,x:110.65,y:140.2},0).wait(1).to({scaleX:0.8487,scaleY:0.8487,x:106,y:147},0).wait(1).to({scaleX:0.8472,scaleY:0.8472,x:102,y:153.1},0).wait(1).to({scaleX:0.8458,scaleY:0.8458,x:98.5,y:158.5},0).wait(1).to({scaleX:0.8447,scaleY:0.8447,x:95.55,y:163.3},0).wait(1).to({scaleX:0.8436,scaleY:0.8436,x:93,y:167.45},0).wait(1).to({scaleX:0.8428,scaleY:0.8428,x:90.9,y:171.05},0).wait(1).to({scaleX:0.842,scaleY:0.842,x:89.1,y:174.15},0).wait(1).to({scaleX:0.8414,scaleY:0.8414,x:87.6,y:176.75},0).wait(1).to({scaleX:0.8409,scaleY:0.8409,x:86.4,y:178.9},0).wait(1).to({scaleX:0.8405,scaleY:0.8405,x:85.4,y:180.65},0).wait(1).to({scaleX:0.8401,scaleY:0.8401,x:84.6,y:182.05},0).wait(1).to({scaleX:0.8399,scaleY:0.8399,x:84.05,y:183.05},0).wait(1).to({scaleX:0.8397,scaleY:0.8397,x:83.65,y:183.8},0).wait(1).to({scaleX:0.8396,scaleY:0.8396,x:83.45,y:184.25},0).wait(1).to({regX:640.1,regY:700,x:352.1,y:478.25},0).to({_off:true},2).wait(552));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},972).wait(58));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).to({_off:true},984).wait(41).to({_off:false},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1158.9,-720,2701.4,1384.2);
// library properties:
lib.properties = {
	id: '_413_4',
	width: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1596090334163", id:"_413_4_bg"},
		{src:"images/book.png?1596090334163", id:"_413_4_book"},
		{src:"images/ch_base.png?1596090334163", id:"_413_4_ch_base"},
		{src:"images/ch_face10.png?1596090334163", id:"_413_4_ch_face10"},
		{src:"images/ch_face11.png?1596090334163", id:"_413_4_ch_face11"},
		{src:"images/ch_face2.png?1596090334163", id:"_413_4_ch_face2"},
		{src:"images/ch_face3.png?1596090334163", id:"_413_4_ch_face3"},
		{src:"images/ch_face4.png?1596090334163", id:"_413_4_ch_face4"},
		{src:"images/ch_face5.png?1596090334163", id:"_413_4_ch_face5"},
		{src:"images/ch_face6.png?1596090334163", id:"_413_4_ch_face6"},
		{src:"images/ch_face7.png?1596090334163", id:"_413_4_ch_face7"},
		{src:"images/ch_face9.png?1596090334163", id:"_413_4_ch_face9"},
		{src:"images/finish.jpg?1596090334163", id:"_413_4_finish"},
		{src:"images/finish_blur.jpg?1596090334163", id:"_413_4_finish_blur"},
		{src:"images/tie_fp.png?1596090334163", id:"_413_4_tie_fp"},
		{src:"images/tie_sp.png?1596090334163", id:"_413_4_tie_sp"}
	],
	preloads: []
};
